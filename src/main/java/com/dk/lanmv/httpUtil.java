...
//        httpGet.addHeader("user-agent", "__cfduid=d17eb0d6a612d8fea6954c4bb2ea3a4801574058813; UM_distinctid=16e7d375e43da5-01d479b99c999-3a614f0b-1fa400-16e7d375e44ca2; PHPSESSID=5qe4t1t6gj9akiel8kf19j1cr2; HISTORY={video:[{\"name\":\"\\u65E5\\u672CNoir-\\u5211\\u4E8BY\\u7684\\u53DB\\u4E71-\",\"link\":\"https://www.nfmovies.com/detail/?40166.html\",\"pic\":\"/uploads/allimg/191015/1c1ea843b8abfd8f.jpg\"},{\"name\":\"\\u653E\\u8BFE\\u540E\\u684C\\u6E38\\u4FF1\\u4E50\\u90E8\",\"link\":\"https://www.nfmovies.com/detail/?39681.html\",\"pic\":\"/uploads/allimg/191004/07ddab33a2596b1a.jpg\"},{\"name\":\"\\u53CC\\u5B50\\u6740\\u624B2019\",\"link\":\"https://www.nfmovies.com/detail/?40412.html\",\"pic\":\"/uploads/allimg/191020/2cf3df79751560de.jpg\"},{\"name\":\"\\u6D6E\\u73B0\",\"link\":\"https://www.nfmovies.com/detail/?39389.html\",\"pic\":\"/uploads/allimg/190926/9182ede884d086ab.jpg\"}]}; CNZZDATA1277238851=648928761-1574057600-https%253A%252F%252Fji-e.pw%252F%7C1574918826");
...
//        nfMoviesVideo();
     ...
     */
    public static void nfMoviesVideo(){
        int i = 0;
        Map<String, String> header = new HashMap<>();
        header.put("referer", "https://www.nfmovies.com/js/player/mp4.html?19112529");
        while(1==1){
            String mainHtml = doGet("https://www.nfmovies.com/video/?40166-0-"+i+".html");
            ...
            String mp4 = doGet("https://www.nfmovies.com/api/vproxy.php?url=" + mp4Url + "&type=json", header);
     ...
     */
    public static void nfMoviesM3u8(){
        int i = 0;
        Map<String, String> header = new HashMap<>();
        header.put("referer", "https://www.nfmovies.com/js/player/mp4.html?19112529");
        while(1==1){
            String mainHtml = doGet("https://www.nfmovies.com/video/?6498-0-"+i+".html");
            Document parse = Jsoup.parse(mainHtml);
            Element element = parse.getElementsByClass("info clearfix").get(0);
            Element element1 = element.select("script").get(1);
            String[] split = element1.data().split("now");
            String m3u8Url = split[1].split( "\"")[1];
            if (m3u8Url==null|| "".equals(m3u8Url)){
                return;
            }

            try {
                System.out.println(URLDecoder.decode(m3u8Url,"UTF-8"));
